from structure_and_functionality_2.movie_app import MovieApp
from structure_and_functionality_2.movie_specification.fantasy import Fantasy
from structure_and_functionality_2.movie_specification.action import Action
